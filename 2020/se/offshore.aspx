...
<div class="wrap-side">
    <div class="content-page">
        <div class="content-page-title"><span>Tillväxt Offshore</span></div>
        ...
        <div class="content-page-block-1">
            <div class="content-page-block-wrap-row">
                ...
                <div class="content-page-block-1-2">
                    <span>AF ska genom organisk och strukturell tillväxt tillsäkra sig en starkare position i offshoremarknaden</span>
                </div>
            </div>
        <div class="content-page-footer">
        ...
        <div class="content-page-block-2">
            <div class="content-page-block-wrap-col">
                <div class="content-page-block-title"><span>Tillväxt Offshore</span></div>
                <div class="content-page-block-grid">
                    <div class="gridbox">
                        <img src="/strategi2020/Styles/img/Multileveranser_storby.png">
                        <span>Bredda tjänsteportföljen och den geografiska närvaron för att bli en totalleverantör.</span>
                    </div>
                    <div class="gridbox">
                        <img src="/strategi2020/Styles/img/Ledergruppe.png">
                        <span>Öka projektorienteringen och tjänsteaspekterna inom HVAC.</span>
                    </div>
                    <div class="gridbox">
                        <img src="/strategi2020/Styles/img/Vekst_tilgrensende.png">
                        <span>Etablera projektbaserade tjänster i gränszonen av befintlig kärnverksamhet på marknader där konjunkturer är oberoende av offshore-avveckling.</span>
                    </div>                   
                </div>
            <div class="content-page-footer">
                <img src="/strategi2020/Styles/img/Gul-pil.png">
